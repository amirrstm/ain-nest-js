...
describe('HelperEncryptionService', () => {
  ...
  beforeEach(async () => {
    ...
    service = moduleRef.get<HelperEncryptionService>(HelperEncryptionService)
  })
  ...
  describe('base64Encrypt', () => {
    it('should return base64 string when given utf8 string', () => {
      expect(service.base64Encrypt('Hello World!')).toBe('SGVsbG8gV29ybGQh')
    })
  })

  describe('base64Decrypt', () => {
    it('should return utf8 string when given base64 string', () => {
      expect(service.base64Decrypt('SGVsbG8gV29ybGQh')).toBe('Hello World!')
    })
  })

  describe('base64Compare', () => {
    it('should return true when given two identical base64 strings', () => {
      expect(service.base64Compare('SGVsbG8gV29ybGQh', 'SGVsbG8gV29ybGQh')).toBe(true)
    })

    it('should return false when given two different base64 strings', () => {
      expect(service.base64Compare('SGVsbG8gV29ybGQh', 'SGVsbG8gV29ybw==')).toBe(false)
    })
  })
