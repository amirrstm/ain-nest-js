...
describe('AuthService', () => {
  ...
  describe('createAccessToken', () => {
    it('should create access token', async () => {
      ...
      jest.spyOn(service['helperEncryptionService'], 'jwtEncrypt').mockReturnValueOnce(expectedToken)
  ...
  describe('validateAccessToken', () => {
    it('should validate access token', async () => {
      ...
      jest.spyOn(service['helperEncryptionService'], 'jwtVerify').mockReturnValueOnce(true)
  ...
  describe('payloadAccessToken', () => {
    it('should payload access token', async () => {
      ...
      jest.spyOn(service['helperEncryptionService'], 'jwtDecrypt').mockReturnValueOnce(expectedPayload)
  ...
  describe('createRefreshToken', () => {
    it('should create refresh token', async () => {
      ...
      jest.spyOn(service['helperEncryptionService'], 'jwtEncrypt').mockReturnValueOnce(expectedToken)
      const payloadHashed = 'test-payload-hash'
      const refreshToken = await service.createRefreshToken(payloadHashed)
  ...
  describe('validateUser', () => {
    it('should validate user password', async () => {
      ...
      const passwordHash = '$2a$08$fzP9lDIQU3HKvnwr6vTWj.oNhh7ZgohAwo7FZ2OvWnQUDRX7/6BdO'

      const isValid = await service.validateUser(passwordString, passwordHash)
      expect(isValid).toBe(true)
    })
  ...
  describe('createPayloadRefreshToken', () => {
    it('should create refresh token payload', async () => {
      ...
      const accessPayload = await service.createPayloadAccessToken(expectedPayload, {
        loginDate: helperDateService.create(),
        loginFrom: ENUM_AUTH_LOGIN_FROM.PASSWORD,
        loginWith: ENUM_AUTH_LOGIN_WITH.EMAIL,
      })
      const _id = 'user-id'
      const payload = await service.createPayloadRefreshToken(_id, accessPayload)
  ...
  describe('createPassword', () => {
    it('should create password', async () => {
      ...
      const { passwordHash, passwordExpired, passwordCreated } = await service.createPassword(password)
